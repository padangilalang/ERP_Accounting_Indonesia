...
?>
<p>
	You have been invited to join {website}.<br /> To activate your account
	and set the new password please click on this link:<br />
	<?php echo $data['{full_link}']; ?>
	<br /> or you can go to this address<br />
	<?php echo $data['{link}']; ?>
	<br /> and insert in the form the following data<br /> username: <b><?php echo $data['{username}']; ?>
	</b><br /> activation code: <b><?php echo $data['{activation_code}']; ?>
	</b>
</p>
