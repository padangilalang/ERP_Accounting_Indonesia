...
<div class="detailHeader" id="<?php echo $property->name.'-detail'; ?>">
	...
	<span class="detailHeaderTag"> property <?php if($property->readOnly) echo ' <em>read-only</em> '; ?>
		<?php if(!empty($property->since)): ?> (available since v<?php echo $property->since; ?>)
		<?php endif; ?>
	</span>
</div>
