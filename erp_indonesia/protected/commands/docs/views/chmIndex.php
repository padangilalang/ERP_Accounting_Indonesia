		...
		<li><object type="text/sitemap">
			...
			<ul>
				...
				<li><object type="text/sitemap">
						...
						<param name="Local"
							value="<?php echo $class->name . '.html#' . $property->name; ?>">
					</object> <?php endif; ?> <?php endforeach; ?> <?php foreach($class->events as $event): ?>
					<?php if(!$event->isInherited): ?>
				
				<li><object type="text/sitemap">
						<param name="Name" value="<?php echo $event->name; ?>">
						<param name="Local"
							value="<?php echo $class->name . '.html#' . $event->name; ?>">
					</object> <?php endif; ?> <?php endforeach; ?> <?php foreach($class->methods as $method): ?>
					<?php if(!$method->isInherited): ?>
				
				<li><object type="text/sitemap">
						<param name="Name" value="<?php echo $method->name; ?>()">
						<param name="Local"
							value="<?php echo $class->name . '.html#' . $method->name; ?>">
					</object> <?php endif; ?> <?php endforeach; ?>
