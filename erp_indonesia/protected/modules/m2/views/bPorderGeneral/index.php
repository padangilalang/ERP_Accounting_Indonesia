...
$this->menu=array(
		...
		array('label'=>'Home PO Inventory', 'icon'=>'home', 'url'=>array('/m2/bPorderInventory')),
);
...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				array('label'=>'UnApproved','url'=>Yii::app()->createUrl('/m2/bPorderGeneral',array("id"=>1)),'active'=>($id==1)),
				array('label'=>'UnPaid/Partial Paid','url'=>Yii::app()->createUrl('/m2/bPorderGeneral',array("id"=>2)),'active'=>($id==2)),
				array('label'=>'Paid','url'=>Yii::app()->createUrl('/m2/bPorderGeneral',array("id"=>3)),'active'=>($id==3)),
				array('label'=>'Show All','url'=>Yii::app()->createUrl('/m2/bPorderGeneral',array("id"=>0)),'active'=>($id==0)),
		),
));
?>
...
<?php $this->widget('bootstrap.widgets.BootGridView', array(
		...
		'columns'=>array(
				...
				array(
						'header'=>'System Ref',
						'type'=>'raw',
						'value'=>'CHtml::link($data->system_ref,Yii::app()->createUrl("/m2/bPorderGeneral/view",array("id"=>$data->id)))',
				),
				//'periode_date',
				//'remark',
				array(
