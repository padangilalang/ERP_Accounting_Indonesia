...
$this->menu=array(
		...
		array('label'=>'Home PO General', 'icon'=>'home', 'url'=>array('/m2/bPorderGeneral')),
);
...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				array('label'=>'UnApproved','url'=>Yii::app()->createUrl('/m2/bPorderInventory',array("id"=>1)),'active'=>($id==1)),
				array('label'=>'UnPaid/Partial Paid','url'=>Yii::app()->createUrl('/m2/bPorderInventory',array("id"=>2)),'active'=>($id==2)),
				array('label'=>'Paid','url'=>Yii::app()->createUrl('/m2/bPorderInventory',array("id"=>3)),'active'=>($id==3)),
				array('label'=>'Show All','url'=>Yii::app()->createUrl('/m2/bPorderInventory',array("id"=>0)),'active'=>($id==0)),
		),
));
?>
...
<?php $this->widget('bootstrap.widgets.BootGridView', array(
		...
		'columns'=>array(
				...
				array(
						'header'=>'System Ref',
						'type'=>'raw',
						'value'=>'CHtml::link($data->system_ref,Yii::app()->createUrl("/m2/bPorderInventory/view",array("id"=>$data->id)))',
				),
				//'system_ref',
				//'periode_date',
				//array(
				...
				array(
						...
						(
								...
								(
										...
										'url'=>'$this->grid->controller->createUrl("/m2/bPorderInventory/update", array("id"=>$data->id))',
								...
								(
										...
										'url'=>'$this->grid->controller->createUrl("/m2/bPorderInventory/view", array("id"=>$data->id,"asDialog"=>1,"gridId"=>$this->grid->id))',
								...
								(
										...
										'url'=>'$this->grid->controller->createUrl("/m2/bPorderInventory/delete", array("id"=>$data->id))',
										'visible'=>'!isset($data->approved_date)',
										'options'=>array(
										/*	'ajax'=>array(
													'type'=>'POST',
													...
													'success'=>'js:function(data){
														$.fn.yiiGridView.update("bPorderInventory-grid", {
															data: $(this).serialize()
													});
													}',
											), 	*/
