...
<div class="page-header">
	<h1><?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/icon/keychain_access.png') ?>
	<?php echo Rights::t('core', 'Permissions'); ?></h1>
</div>
	...
	<p><?php //echo CHtml::link(Rights::t('core', 'Generate items for controller actions'), array('authItem/generate'), array('class'=>'generator-link btn',)); 
	?></p>
