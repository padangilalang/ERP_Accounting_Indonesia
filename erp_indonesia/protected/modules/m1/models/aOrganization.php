...
class aOrganization extends CActiveRecord
{
	...
	public function getListPersonalia() {
		...
		$returnarray = array('label' => $this->name, 'url' => Yii::app()->createUrl("/m1/cPersonalia/index",array("id"=>$this->id)));
	...
	public function getListAbsence() {
		...
		$returnarray = array('label' => $this->name, 'url' => Yii::app()->createUrl("/m1/cAbsence/index",array("id"=>$this->id)));
