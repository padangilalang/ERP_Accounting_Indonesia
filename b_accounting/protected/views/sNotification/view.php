...
<div class="page-header">
	...
	<?php echo $model->sender_ref ?></h1>
</div>

<div class="row-fluid">
	<div class="span12">
		<div class="well">
			<h4><?php echo sUser::model()->findName($model->sender_id). ' to ' . sUser::model()->findName($model->receiver_id) ?> | 
			<?php echo sParameter::item("cCategory",$model->category_id) ?></h4>
			<br/>
