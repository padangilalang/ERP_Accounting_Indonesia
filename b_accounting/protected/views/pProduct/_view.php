...
<br />
<b><?php echo CHtml::encode($data->getAttributeLabel('no_bpkb')); ?>:</b>
<?php echo CHtml::encode($data->no_bpkb); ?>
<br />
<b><?php echo CHtml::encode($data->getAttributeLabel('stnk_berlaku_sd')); ?>:</b>
...
<br />
<b><?php echo CHtml::encode($data->getAttributeLabel('no_rangka')); ?>:</b>
