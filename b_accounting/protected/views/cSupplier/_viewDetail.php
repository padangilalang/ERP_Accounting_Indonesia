	...
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('company_name')); ?>:</b>
	<?php echo CHtml::encode($data->company_name); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('pic')); ?>:</b>
	...
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('address3')); ?>:</b>
